                    ...
                    <div class="widget widget-table-two">
                        ...
                        <div class="widget-content">
                            <div class="table-responsive">
                                <table id="dtVisitsList"  class="table" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th><div class="th-content ">Beneficiary</div></th>
                                            <th><div class="th-content ">Hospital</div></th>
                                            <th><div class="th-content ">Visit</div></th>
                                            <th><div class="th-content">Dates</div></th>
...
function editschedule(id)
                        {
                            if (id != "") {
                                ...
                                window.location.href = "<?= base_url("/schedule") ?>/"+id;
                        ...
                        function editstatus(id)
                        {
                            if (id != "") {
                                ...
                                window.location.href = "<?= base_url("/visitstatus") ?>/"+id;
