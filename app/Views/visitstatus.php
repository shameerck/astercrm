                ...
                <div id="flHorizontalForm" class="col-lg-12 col-12 layout-spacing">
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <div class="form-group row">
                                <label for="hEmail" class="col-xl-2">Scheduled Date</label>
                                <div class="col-xl-4">
                                    <input type="hidden" id="visitid" value="<?= $visitid ?>">                                    

<strong><?= $visitingdate ?></strong>
 ...
 <input class="form-control"  type="datetime-local" id="dateTimeFlatpickr"
       name="dateTimeFlatpickr" value="<?= $visiteddate ?>" >
                            ...
                            <div class="form-group row">
                                <label for="hEmail" class="col-xl-2">Status</label>
                                <div class="col-xl-4">
<select id="visitstatus" class="form-control">
    ...
    <option value="3" <?php if($visitedstatus==3) echo "selected"; ?>>Cancelled</option>
                            ...
                            <div class="form-group row">
                                <label for="hEmail" class="col-xl-2">Comments</label>
                                <div class="col-xl-4">

                            <textarea class="form-control" id="visitcomments" rows="3"></textarea>
                                </div>
           ...
           function savevisit()
                        {
                            ...
                            if ($("#visitstatus").val() === "Select") {
                                $("#visitstatus-invalid").css('display', 'block');
                                validation = 1;
                            } else
                            {
                                $("#visitstatus-invalid").css('display', 'none');
                            }
                            ...
                            var visit_status = $("#visitstatus").val();
                            var visit_comments = $("#visitcomments").val();


                            $.ajax({
                                url: "<?= base_url('savestatus') ?>",
                                data: {visitid:visit_id, visiteddate: visit_date, visitstatus: visit_status, visitcomments: visit_comments },
                                dataType: "json",
                                type: "POST",
                                error: function (msg) {
